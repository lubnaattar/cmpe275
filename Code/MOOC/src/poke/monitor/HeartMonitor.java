...
public class HeartMonitor {
	...
	public void removeListner(String nodeId, MonitorListener listener)
	{
		if (handler == null && !listeners.contains(listener)) {
	...
	public void release() {
		...
		System.out.println("release method in heartmonitor class");
	...
	public boolean stopHeartbeat() {
		...
		try {
			...
			logger.info("sending mgmt leave message");
			Network.Builder n = Network.newBuilder();
			n.setNodeId("mgmt-" + whoami + "." + N);
